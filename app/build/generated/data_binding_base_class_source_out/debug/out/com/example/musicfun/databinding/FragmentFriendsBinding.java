...
public final class FragmentFriendsBinding implements ViewBinding {
  ...
  private FragmentFriendsBinding(@NonNull RelativeLayout rootView,
      @NonNull BottomNavigationView FriendsNav, @NonNull RelativeLayout rlSearch) {
  ...
  public static FragmentFriendsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.FriendsNav;
      BottomNavigationView FriendsNav = ViewBindings.findChildViewById(rootView, id);
      if (FriendsNav == null) {
        break missingId;
      }
      ...
      return new FragmentFriendsBinding((RelativeLayout) rootView, FriendsNav, rlSearch);
    }
