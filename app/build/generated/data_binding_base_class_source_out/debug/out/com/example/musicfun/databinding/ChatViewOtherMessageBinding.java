...
public final class ChatViewOtherMessageBinding implements ViewBinding {
  @NonNull
  ...
  private ChatViewOtherMessageBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ChatViewOtherMessageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ChatViewOtherMessageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.chat_view_other_message, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ChatViewOtherMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ChatViewOtherMessageBinding((ConstraintLayout) rootView, cardGchatMessageOther,
